          ...
          <TableBody>
            <TableRow>
              ...
              >
                ...
                <ul>
                  <li>
                    Setting aside scheduled time for social and leisure
                    activities every week.
                  </li>
                  <li>
                    Signing up for a weekly class/activity at your local
                    recreation or community center.
                  </li>
                  <li>
                    Sharing your caregiving responsibilities with family or
                    friends.
                  </li>
                  <li>
                    Accessing formal supports such as adult day programs or
                    companionship.
                  </li>
                  <li>
                    Gardening, reading, going for a walk, or listening to music.
                  </li>
              ...
              <TableCell sx={{ width: "50%", verticalAlign: "top" }}>
                ...
                <ul>
                  ...
                  <li>
                    Trying to carry the weight of your caregiving
