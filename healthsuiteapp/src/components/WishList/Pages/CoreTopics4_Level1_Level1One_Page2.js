...
const CoreTopics4_Level1_Level1One_Page2 = () => {
  const pageId = "CoreTopics4_Level1_Level1One_Page2"; // Unique identifier for this page
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Level 1.1: Tips for Asking for Help
        </Typography>
            ...
            <TableRow>
              ...
              >
                ...
                <ul>
                  ...
                  <li>
                    Listening to the person's reasons for not wanting help from
                    others.
                  </li>
                  <li>Informing the person that you also need help.</li>
                  <li>
                    Discussing the abilities of the individual offering to help
                    and what they may be comfortable helping with.
                  </li>
                </ul>
              </TableCell>
              <TableCell sx={{ width: "50%", verticalAlign: "top" }}>
                ...
                <ul>
                  <li>
                    Using 'you' statements, such as "You need to help with..."
                  </li>
...
export default CoreTopics4_Level1_Level1One_Page2;
