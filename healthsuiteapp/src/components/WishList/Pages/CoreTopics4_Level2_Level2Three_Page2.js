...
const CoreTopics4_Level2_Level2Three_Page2 = () => {
  const pageId = "CoreTopics4_Level2_Level2Three_Page2"; // Unique identifier for this page
...
export default CoreTopics4_Level2_Level2Three_Page2;
