...
const Page2 = () => {
    ...
    const handlePrevious = () => {
        navigate('/library/core-topic4/level1/level1four/page1'); // Correct previous page path
    };

    const handleNext = () => {
        navigate('/library/core-topic4/level1/level1five/page1'); // Correct next page path
    };
