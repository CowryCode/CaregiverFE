...
const Page2 = () => {
    ...
    const handlePrevious = () => {
        navigate('/library/core-topic4/level1/level1two/page1'); // Adjust this path to point to the previous page
    };

    const handleNext = () => {
        navigate('/library/core-topic4/level1/level1three/page1'); // Adjust this path to point to the next page, if exists
    };
