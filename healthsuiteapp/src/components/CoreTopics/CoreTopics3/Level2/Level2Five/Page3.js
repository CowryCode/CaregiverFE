...
const Page3 = () => {
    ...
    const handlePrevious = () => {
        navigate('/library/core-topic3/level2/level2five/page2'); // Correct previous page path
    };

    const handleNext = () => {
        navigate('/library/core-topic3/level2/level2six/page1'); // Correct next page path
    };
