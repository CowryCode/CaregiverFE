...
const Page3 = () => {
    ...
    const handlePrevious = () => {
        navigate('/library/core-topic3/level2/level2seven/page2'); // Correct previous page path
    };

    const handleNext = () => {
        navigate('/library/core-topic3/level2/level2eight/page1'); // Correct next page path
    };
