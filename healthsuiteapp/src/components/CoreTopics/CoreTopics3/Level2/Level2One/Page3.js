...
const Page3 = () => {
    ...
    const handlePrevious = () => {
        navigate('/library/core-topic3/level2/level2one/page2'); // Correct previous page path
    };

    const handleNext = () => {
        navigate('/library/core-topic3/level2/level2two/page1'); // Correct next page path
    };
