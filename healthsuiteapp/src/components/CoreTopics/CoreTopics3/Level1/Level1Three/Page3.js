...
const Page3 = () => {
    ...
    const handlePrevious = () => {
        navigate('/library/core-topic3/level1/level1three/page2'); // Adjust this path to point to the previous page
    };

    const handleNext = () => {
        navigate('/library/core-topic3/level2'); // Adjust this path to point to the next level, if exists
    };
